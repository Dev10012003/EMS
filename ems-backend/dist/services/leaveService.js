...
export class LeaveService {
    ...
    async getByEmployeeId(dto) {
        ...
        const { leaves, totalRecords } = await leaveRepository.getByEmployeeId(empId, dto.status, pageNumber, pageSize, dto.orderBy || "appliedAt", dto.orderDirection || "asc");
