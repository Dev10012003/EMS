...
import { resetPassword, forgotPassword, login, verify, } from "../controllers/authController.js";
...
router.post("/forgot-password", validateDTO(ForgotPasswordRequestDTO), forgotPassword);
router.post("/reset-password/:token", validateDTO(ResetPasswordRequestDTO), resetPassword);
