...
import { IAddEmployeeFormValues } from "../../interfaces/Employee";
import {
...
function Add() {
  ...
  const initialValues: IAddEmployeeFormValues = {
    name: "",
    email: "",
    employeeId: "",
    dob: "",
  ...
  const formik = useFormik<IAddEmployeeFormValues>({
    initialValues,
    validationSchema,
        ...
        <div className="bg-white p-6 sm:p-8 md:p-10 lg:p-8 rounded-md shadow-lg">
          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="common-form-label">Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div>
                <label className="common-form-label">Employee Id</label>
                <input
                  type="text"
                  name="employeeId"
              ...
              <div>
                <label className="common-form-label">Salary</label>
                <input
                  type="number"
                  name="salary"
              ...
              <div>
                <label className="common-form-label">Password</label>
                <input
                  type="password"
                  name="password"
              ...
              <div>
                <label className="common-form-label">Upload Image</label>
                <input
                  type="file"
                  name="image"
